-- CreateEnum
CREATE TYPE "CreditBucketType" AS ENUM ('PURCHASED', 'BONUS', 'REFERRAL');

-- DropForeignKey
ALTER TABLE "CreditTransaction" DROP CONSTRAINT IF EXISTS "CreditTransaction_creatorId_fkey";

-- DropTable
DROP TABLE IF EXISTS "UserCredits";

-- DropTable
DROP TABLE IF EXISTS "UnlockedFlow";

-- AlterTable
ALTER TABLE "User" ADD COLUMN IF NOT EXISTS "lastLogin" TIMESTAMP(3);

-- AlterTable
ALTER TABLE "CreditTransaction" DROP COLUMN IF EXISTS "type";
